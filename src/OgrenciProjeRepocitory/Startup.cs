...
namespace OgrenciProjeRepocitory
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<OgrenciContext>(x => x.UseSqlServer(Configuration.GetConnectionString("Baglanti")));
            services.AddScoped<BolumModel>();
            services.AddScoped<OgrenciModel>();
            services.AddScoped<RepBolum>();
            services.AddScoped<RepOgrenci>();
        }
